...
public class DungeonFracture extends HiddenItem {
    ...
    public DungeonFracture(String id, Particle particle) {
        super(QDGroups.DUNGEON, new SlimefunItemStack(id, new ItemStack(Material.BARRIER)), QDRecipeType.DUMMY, new ItemStack[9]);
    ...
    public BlockTicker onTick() {
        return new BlockTicker() {
            ...
            public void tick(Block block, SlimefunItem item, Config config) {
                QDEffects.animateFracture(block, particle);
            }
