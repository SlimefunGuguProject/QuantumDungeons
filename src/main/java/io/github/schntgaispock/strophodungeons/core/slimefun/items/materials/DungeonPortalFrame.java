        ...
        addItemHandler(new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(@Nonnull BlockPlaceEvent e) {
                ...
                for (Vector vector : searchLocations) {
                    ...
                    if (newLocation != null && !BlockStorage.check(newLocation, "DUNGEON_PORTAL_MOUND"))
                        continue;

                    short connectedFrames = SDBlockStorage.getShort(newLocation, "connected_frames");
                    SDBlockStorage.set(newLocation, "connected_frames", connectedFrames + 1);
