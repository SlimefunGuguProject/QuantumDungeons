...
public class SDRecipes {
    ...
    public static class SDRecipeType extends RecipeType {
        ...
        public static final RecipeType REFLECTING = new SDRecipeType("反映", SDStacks.RECIPE_REFLECTING);
        public static final RecipeType MOULDING = new SDRecipeType("模制", SDStacks.RECIPE_MOULDING);
        public static final RecipeType KILLING = new SDRecipeType("杀人修补", SDStacks.RECIPE_KILLING);
        public static final RecipeType LOOTING = new SDRecipeType("抢夺", SDStacks.RECIPE_LOOTING);
        public static final RecipeType MENDING = new SDRecipeType("修补", SDStacks.RECIPE_MENDING);
        public static final RecipeType BOOSTING = new SDRecipeType("增长", SDStacks.RECIPE_BOOSTING);
        public static final RecipeType DUMMY = new SDRecipeType("假", new ItemStack(Material.BARRIER));
